            ...
            <div className="footer-container">
                <div className="footer-grid">
                    <div className="footer-brand">
                        ...
                        <p className="footer-description">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</p>
                        <ul className="footer-social-links">
                            <li>
                                <a href="#" title="" className="footer-social-link">
                ...
                <p className="footer-copyright">© Copyright 2024, All Rights Reserved by Spiritual Insights</p>
            </div>
        </section>
    );
}
